...
-- Science
UPDATE Language_en_US
SET Text = 'Each [ICON_PUPPET] non-Puppet City adds +({1_Str}% + {3_Str}% x current non-Puppet Cities) of base [ICON_RESEARCH] Science cost.'
WHERE Tag = 'TXT_KEY_TP_TECH_CITY_COST';

UPDATE Language_en_US
SET Text = '[ICON_BULLET]Current research cost: {1_Num} [ICON_RESEARCH] Science = {2_Num} [ICON_RESEARCH] base + {3_Num} [ICON_RESEARCH] (+{5_Str}% from {7_Num} {7_Num: plural 1?city; other?cities;}).[NEWLINE][ICON_BULLET]Gaining a new City will add [COLOR_NEGATIVE_TEXT]+{4_Num}[ENDCOLOR] [ICON_RESEARCH] (+{6_Str}% of base cost).'
...
-- Culture
UPDATE Language_en_US
SET Text = 'Each [ICON_PUPPET] non-Puppet City adds +({1_Str}% + {3_Str}% x current non-Puppet Cities) of base [ICON_CULTURE] Culture cost.'
WHERE Tag = 'TXT_KEY_TP_CULTURE_CITY_COST';

UPDATE Language_en_US
SET Text = '[ICON_BULLET]Next policy cost: {1_Num} [ICON_CULTURE] Culture = {2_Num} [ICON_CULTURE] base + {3_Num} [ICON_CULTURE] (+{5_Str}% from {7_Num} {7_Num: plural 1?city; other?cities;}).[NEWLINE][ICON_BULLET]Gaining a new City will add [COLOR_NEGATIVE_TEXT]+{4_Num}[ENDCOLOR] [ICON_CULTURE] (+{6_Str}% of base cost).'
