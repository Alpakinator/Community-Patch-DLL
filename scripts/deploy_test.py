...
# ---------------------------------------------------------------------------
# Defaults (Linux / Proton paths)
# ---------------------------------------------------------------------------
DEFAULT_MODS_DIR = Path(
    "/home/sunny/chest/SteamLibrary/steamapps/compatdata/8930/pfx/drive_c/users/steamuser/Documents/My Games/Sid Meier's Civilization 5/MODS"
)
DEFAULT_DLC_DIR = Path(
    "/home/sunny/chest/SteamLibrary/steamapps/common/Sid Meier's Civilization V/Assets/DLC"
)
        ...
        for filename in files:
            ...
            if dst_file.exists():
                ...
                if src_size == dst_size:
                    # Fast path: destination is at least as new as source.
                    if src_mtime <= dst_mtime:
                        skipped += 1
                        continue
                    # Source may have a newer mtime due to checkout/copy, but still be identical.
