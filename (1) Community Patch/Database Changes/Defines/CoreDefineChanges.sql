...
-- Weight of warmonger triggers
	...
	-- Nuclear weapon penalties (3x atomic vs missile, 80% reduction for counter-attacks)
	('WARMONGER_THREAT_FIRST_ATOMIC_BOMB_WEIGHT', 4000),
	('WARMONGER_THREAT_FIRST_NUCLEAR_MISSILE_WEIGHT', 12000),
	('WARMONGER_THREAT_SUBSEQUENT_ATOMIC_BOMB_WEIGHT', 2000),
	('WARMONGER_THREAT_SUBSEQUENT_NUCLEAR_MISSILE_WEIGHT', 6000),
	('WARMONGER_THREAT_SUBSEQUENT_ATTACKER_MULTIPLIER', 70),
	('WARMONGER_THREAT_COUNTER_ATTACK_NUKE_USER_MULTIPLIER', 20),
