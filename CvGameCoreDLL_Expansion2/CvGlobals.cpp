...
CvGlobals::CvGlobals() :
	...
	GD_INT_INIT(WARMONGER_THREAT_FIRST_ATOMIC_BOMB_WEIGHT, 4000),
	GD_INT_INIT(WARMONGER_THREAT_FIRST_NUCLEAR_MISSILE_WEIGHT, 12000),
	GD_INT_INIT(WARMONGER_THREAT_SUBSEQUENT_ATOMIC_BOMB_WEIGHT, 2000),
	GD_INT_INIT(WARMONGER_THREAT_SUBSEQUENT_NUCLEAR_MISSILE_WEIGHT, 6000),
	GD_INT_INIT(WARMONGER_THREAT_SUBSEQUENT_ATTACKER_MULTIPLIER, 70),
	GD_INT_INIT(WARMONGER_THREAT_COUNTER_ATTACK_NUKE_USER_MULTIPLIER, 20),
...
void CvGlobals::cacheGlobals()
{
	...
	GD_INT_CACHE(WARMONGER_THREAT_FIRST_ATOMIC_BOMB_WEIGHT);
	GD_INT_CACHE(WARMONGER_THREAT_FIRST_NUCLEAR_MISSILE_WEIGHT);
	GD_INT_CACHE(WARMONGER_THREAT_SUBSEQUENT_ATOMIC_BOMB_WEIGHT);
	GD_INT_CACHE(WARMONGER_THREAT_SUBSEQUENT_NUCLEAR_MISSILE_WEIGHT);
	GD_INT_CACHE(WARMONGER_THREAT_SUBSEQUENT_ATTACKER_MULTIPLIER);
	GD_INT_CACHE(WARMONGER_THREAT_COUNTER_ATTACK_NUKE_USER_MULTIPLIER);
