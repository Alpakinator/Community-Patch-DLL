...
public:
	...
	GD_INT_MEMBER(WARMONGER_THREAT_FIRST_ATOMIC_BOMB_WEIGHT); // VP
	GD_INT_MEMBER(WARMONGER_THREAT_FIRST_NUCLEAR_MISSILE_WEIGHT); // VP
	GD_INT_MEMBER(WARMONGER_THREAT_SUBSEQUENT_ATOMIC_BOMB_WEIGHT); // VP
	GD_INT_MEMBER(WARMONGER_THREAT_SUBSEQUENT_NUCLEAR_MISSILE_WEIGHT); // VP
	GD_INT_MEMBER(WARMONGER_THREAT_SUBSEQUENT_ATTACKER_MULTIPLIER); // VP
	GD_INT_MEMBER(WARMONGER_THREAT_COUNTER_ATTACK_NUKE_USER_MULTIPLIER); // VP
